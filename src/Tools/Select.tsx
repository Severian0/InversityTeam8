...
type SelectTriggerProps<T extends ValidComponent = "button"> = any;
...
type SelectContentProps<T extends ValidComponent = "div"> = any;
...
type SelectItemProps<T extends ValidComponent = "li"> = any;
